...
@UdfDescription(
    ...
    description = "Add to local datetimes",
    author = "Hans-Peter Grahsl (follow @hpgrahsl)",
    version = "0.1.0"
    )
public class UdfLocalDateTimePlus {

  @Udf(description = "Add a period and/or duration to a local datetime",
      schema = DateTimeSchemas.LOCALDATETIME_SCHEMA_DESCRIPTOR)
  public Struct plus(
      @UdfParameter(
          value = "baseLocalDateTime",
          description = "the local datetime to add to",
          schema = DateTimeSchemas.LOCALDATETIME_SCHEMA_DESCRIPTOR)
  ...
  @Udf(description = "Add years, months, days, hours, minutes, seconds and nanos to a local datetime",
      schema = DateTimeSchemas.LOCALDATETIME_SCHEMA_DESCRIPTOR)
  public Struct plus(
      @UdfParameter(
          value = "baseLocalDateTime",
    ...
    if (baseLocalDateTime == null || addYears == null || addMonths == null || addDays == null
