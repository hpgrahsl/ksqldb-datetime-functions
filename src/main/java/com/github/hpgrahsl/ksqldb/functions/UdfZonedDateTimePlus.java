...
@UdfDescription(
    ...
    description = "Add to zoned datetimes",
    author = "Hans-Peter Grahsl (follow @hpgrahsl)",
    version = "0.1.0"
    )
public class UdfZonedDateTimePlus {

  @Udf(description = "Add a period and/or duration to an zoned datetime",
      schema = DateTimeSchemas.ZONEDDATETIME_SCHEMA_DESCRIPTOR)
  public Struct plus(
      @UdfParameter(
          value = "baseZonedDateTime",
          description = "the zoned datetime to add to",
          schema = DateTimeSchemas.ZONEDDATETIME_SCHEMA_DESCRIPTOR)
  ...
  @Udf(description = "Add years, months, days, hours, minutes, seconds and nanos to an zoned datetime",
      schema = DateTimeSchemas.ZONEDDATETIME_SCHEMA_DESCRIPTOR)
  public Struct plus(
      @UdfParameter(
          value = "baseZonedDateTime",
    ...
    if (baseZonedDateTime == null || addYears == null || addMonths == null || addDays == null
